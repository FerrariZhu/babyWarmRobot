...
import type { Scenario } from "@baby-outfit/core";
        ...
        <Link
          ...
          className={
            active === s
              ...
              : "shrink-0 rounded-full border border-outline-variant bg-surface-container-lowest px-5 py-2 font-label-caps text-on-surface-variant shadow-cloud transition-all hover:bg-surface-container-low active:scale-95"
          }
        >
          {SCENARIO_LABELS[s]}
        </Link>
