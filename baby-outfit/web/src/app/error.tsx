...
export default function Error({
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-[var(--spacing-margin-mobile)]">
      <div className="w-full max-w-md rounded-[2rem] border border-surface-container-highest bg-surface-container-lowest p-8 text-center shadow-cloud">
        ...
        <div className="mt-6 flex flex-col gap-3">
          <button
            type="button"
            onClick={reset}
            className="font-label-caps rounded-full bg-primary py-3 text-on-primary"
          >
            重试
          </button>
